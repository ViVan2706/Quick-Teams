    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {visibleMatches.map((team, index) => {
          console.log("Full team object:", team);        // logs everything
          console.log("Team skills:", team.skill_req);   // logs skills only
          ...
          return (
            <TeamCard
              ...
              techstack={team.skill_req}
              maxMembers={team.team_size}
